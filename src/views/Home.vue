...
<a xlink:title="CE"  class="pointer" @click="showModal = true"><path fill-rule="evenodd" clip-rule="evenodd" d="M720.22 280.727L705.08 183.03C740.321 180.355 765.425 200.033 784.29 220.231L754.855 263.67L763.627 283.196L753.685 294.665L738.545 280.142L720.22 280.727V280.727V280.727Z" fill="white" stroke="#3C2243" stroke-width="1.5" stroke-linejoin="round"/></a>
...
<a xlink:title="DF" class="pointer" @click="showModal = true"><path fill-rule="evenodd" clip-rule="evenodd" d="M573.533 465.053L573.943 449.587L548.266 445.301L547.632 465.761L573.533 465.053V465.053Z" fill="white" stroke="#3C2243" stroke-width="1.5" stroke-linejoin="round"/></a>
...
<div id="bottom">
<button id="botao"><img id="lupa" src="../images/lupa.png" alt=""></button>
</div>
...
<div>
    <vue-final-modal id="Mood" v-model="showModal" classes="modal-container" content-class="modal-content">
      <button class="modal__close" @click="showModal = false">
        <mdi-close><img style="width: 10px" src="../images/X.png" alt=""></mdi-close>
      </button>
      <span class="modal__title"> NOME DO ESTADO </span>
